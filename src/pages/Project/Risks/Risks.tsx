        ...
        <div>
          <table className="w-full mt-[30px] border-collapse">
            ...
            <tbody>
              {risks.map((risk: Risk) => (
                ...
                >
                  <td className="gap-[10px] text-left">{risk.name}</td>
                  <td
                    style={{ color: getColor(risk.probability) }}
                  ...
                  <td className="text-center">
                    <div className="w-full flex justify-center">
                      <div
                        style={{ backgroundColor: getColor(risk.level) }}
          ...
          {risks.length === 0 && (
            <div className="text-[18px] h-[40px] w-full text-center mt-2">
              <span className="text-center">There are no risks yet</span>
            </div>
          )}
        </div>
      </Page>
